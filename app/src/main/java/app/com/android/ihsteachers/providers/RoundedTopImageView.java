...
public class RoundedTopImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private int mRadius = convertDpToPixel(7);
    private int mWidth;
    private int mHeight;
    ...
    public RoundedTopImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RoundedTopImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
